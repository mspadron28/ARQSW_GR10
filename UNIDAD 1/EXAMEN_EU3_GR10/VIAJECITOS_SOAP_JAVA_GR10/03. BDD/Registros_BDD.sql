-- REGISTROS DE BASE DE DATOS PARA VIAJECITOS SOAP JAVA GRUPO 10
...
-- Inserción de 3 clientes (sin cambios)
...
-- Inserción de 3 usuarios (sin cambios)
...
-- Inserción de 5 compras (sin cambios)
