...
/**
 * Cliente de consola para el servicio REST CONUNI.
 * @author MATIAS
 */
public class CONUNI_CLICON_GR10 {

    private static final AppControlador controlador = new AppControlador();
 ...
 private static void mostrarSullivan() {
    ...
    private static void mostrarMenu() {
        while (true) {
            ...
            mostrarSullivan();
            System.out.println("╔══════════════════════════════════════╗");
            System.out.println("║   **Conversor de Unidades REST**     ║");
            System.out.println("╠══════════════════════════════════════╣");
