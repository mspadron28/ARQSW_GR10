...
namespace ClienteConsolaSOAP
{
    class Program
    {
        private static ConversionServiceClient client;
        ...
        private static async Task<bool> IniciarSesionAsync()
        {
            while (true)
            {
                ...
                try
                {
                    ...
                    {
                        bool success = await client.LoginAsync(usuario, contraseña);
                        if (success)
                        {
        ...
        private static async Task ConvertirPulgadasACentimetrosAsync()
        {
            ...
            try
            {
                ...
                else
                {
                    using (client = new ConversionServiceClient())
                    {
                        double centimetros = await client.pulgadasACentimetrosAsync(pulgadas);
        ...
        private static async Task ConvertirCentimetrosAPulgadasAsync()
        {
            ...
            try
            {
                ...
                else
                {
                    using (client = new ConversionServiceClient())
                    {
                        double pulgadas = await client.centimetrosAPulgadasAsync(centimetros);
        ...
        private static async Task ConvertirMetrosAPiesAsync()
        {
            ...
            try
            {
                ...
                else
                {
                    using (client = new ConversionServiceClient())
                    {
                        double pies = await client.metrosAPiesAsync(metros);
        ...
        private static async Task ConvertirPiesAMetrosAsync()
        {
            ...
            try
            {
                ...
                else
                {
                    using (client = new ConversionServiceClient())
                    {
                        double metros = await client.piesAMetrosAsync(pies);
        ...
        private static async Task ConvertirMetrosAYardasAsync()
        {
            ...
            try
            {
                ...
                else
                {
                    using (client = new ConversionServiceClient())
                    {
                        double yardas = await client.metrosAYardasAsync(metros);
        ...
        private static async Task ConvertirYardasAMetrosAsync()
        {
            ...
            try
            {
                ...
                else
                {
                    using (client = new ConversionServiceClient())
                    {
                        double metros = await client.yardasAMetrosAsync(yardas);
